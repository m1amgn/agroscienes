...
class FieldRecipe(models.Model):
    quantity_of_RO260 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    quantity_of_RO203 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    pesticide_1 = models.CharField(max_length=50, blank=True, null=True)
    quantity_of_pesticide_1 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    pesticide_2 = models.CharField(max_length=50, blank=True, null=True)
    quantity_of_pesticide_2 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    pesticide_3 = models.CharField(max_length=20, blank=True, null=True)
    quantity_of_pesticide_3 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    sas = models.CharField(max_length=20, blank=True, null=True)
    quantity_of_sas = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    complex_fertilizer = models.CharField(max_length=50, blank=True, null=True)
    quantity_of_complex_fertilize = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    created_timestamp = models.DateTimeField(auto_now_add=True)
...
class CostsOnField(models.Model):
    costs_of_RO260 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    costs_of_RO203 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    pesticide_1 = models.CharField(max_length=50, blank=True, null=True)
    costs_of_pesticide_1 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    pesticide_2 = models.CharField(max_length=50, blank=True, null=True)
    costs_of_pesticide_2 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    pesticide_3 = models.CharField(max_length=50, blank=True, null=True)
    costs_of_pesticide_3 = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    sas = models.CharField(max_length=50, blank=True, null=True)
    costs_of_sas = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    complex_fertilizer = models.CharField(max_length=50, blank=True, null=True)
    costs_of_complex_fertilize = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    created_timestamp = models.DateTimeField(auto_now_add=True)
