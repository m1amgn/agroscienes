...
class FieldRecipeSerializer(serializers.ModelSerializer):
    class Meta:
        model = FieldRecipe
        fields = ('quantity_of_RO260', 'quantity_of_RO203', 'pesticide_1', 'quantity_of_pesticide_1', 'pesticide_2', 'quantity_of_pesticide_2', 'pesticide_3',
                  'quantity_of_pesticide_3', 'sas', 'quantity_of_sas', 'complex_fertilizer', 'quantity_of_complex_fertilize')
...
class TestSolutionSerializer(serializers.ModelSerializer):
    class Meta:
        model = TestSolution
        fields = ('pesticide_1', 'quantity_of_pesticide_1', 'pesticide_2', 'quantity_of_pesticide_2', 'pesticide_3',
                  'quantity_of_pesticide_3', 'sas', 'quantity_of_sas', 'complex_fertilizer', 'quantity_of_complex_fertilize')
...
class CostsOnFieldSerializer(serializers.ModelSerializer):
    class Meta:
        model = CostsOnField
        fields = ('costs_of_RO260', 'costs_of_RO203', 'pesticide_1', 'costs_of_pesticide_1', 'pesticide_2', 'costs_of_pesticide_2', 'pesticide_3',
                  'costs_of_pesticide_3', 'sas', 'costs_of_sas', 'complex_fertilizer', 'costs_of_complex_fertilize')


class CostsOnHaSerializer(serializers.ModelSerializer):
    class Meta:
        model = CostsOnHa
        fields = ('costs_of_RO260', 'costs_of_RO203', 'pesticide_1', 'costs_of_pesticide_1', 'pesticide_2', 'costs_of_pesticide_2', 'pesticide_3',
                  'costs_of_pesticide_3', 'sas', 'costs_of_sas', 'complex_fertilizer', 'costs_of_complex_fertilize')
